...
df_meth <- readr::read_csv(here("raw_data", "methylation.csv"), col_types = "innnf")
...
df_meth_tall <- df_meth |> tidyr::pivot_longer(cols = c(-kood, -MAOA.uVNTR),
                                               names_to = "age",
...
There was no significant interaction between age and zinc.

```{r age-zink}

fmla3 <- as.formula("CpG3.methylation ~ Zink * age_cent")
